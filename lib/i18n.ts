...
export const translations = {
  zh: {
    ...
    resume: {
      ...
      experience: {
        alibaba: {
          title: content.resume.experiences[0].position,
          company: content.resume.experiences[0].company,
          period: content.resume.experiences[0].period,
          description: content.resume.experiences[0].description
        },
        meituan: {
        ...
        education: {
          ...
          school: content.resume.education.school,
          major: content.resume.education.major,
          period: content.resume.education.period
        }
      }
    },
    contact: {
  ...
  en: {
    ...
    hero: {
      ...
      location: content.hero.locationEn,
      phone: content.hero.phone,
      email: content.hero.email,
    ...
    resume: {
      ...
      experience: {
        ...
        education: {
          title: content.resume.education.titleEn,
          school: content.resume.education.schoolEn,
          major: content.resume.education.majorEn,
          period: content.resume.education.period
        }
      }
    },
